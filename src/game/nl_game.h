...
// 角色之间碰撞检测
int Algo_CharacterCollisionTesting(const GL_NETLizard_3D_Model *model, const game_character *gamer, const nl_vector3_s *new_v, const game_character *characters, int start, int count, int *character_index, nl_vector3_s *rv);
// 射击 生成子弹对象到链表
